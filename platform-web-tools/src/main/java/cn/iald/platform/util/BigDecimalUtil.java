...
public class BigDecimalUtil {
     ...
     * @return
     */
    public static BigDecimal divide(Integer scale, String dividend, String... divisor) {
     ...
     * @return
     */
    public static BigDecimal divide(Integer scale, int roundingMode, String dividend, String... divisor) {
        BigDecimal result = new BigDecimal(dividend);
        if (ArrayUtils.isNotEmpty(divisor)) {
            for (String temp : divisor) {
                result = result.divide(new BigDecimal(temp), 11, BigDecimal.ROUND_HALF_EVEN);
     ...
     * @return
     */
    public static BigDecimal subtract(Integer scale, String subtract, String... subtrahend) {
     ...
     * @return
     */
    public static BigDecimal subtract(Integer scale, int roundingMode, String subtract, String... subtrahend) {
        BigDecimal result = new BigDecimal(subtract);
        if (ArrayUtils.isNotEmpty(subtrahend)) {
            for (String temp : subtrahend) {
                result = result.subtract(new BigDecimal(temp));
     ...
     * @return
     */
    public static BigDecimal add(Integer scale, String addend, String... augend) {
     ...
     * @return
     */
    public static BigDecimal add(Integer scale, int roundingMode, String addend, String... augend) {
        BigDecimal result = new BigDecimal(addend);
        if (ArrayUtils.isNotEmpty(augend)) {
            for (String temp : augend) {
                result = result.add(new BigDecimal(temp));
